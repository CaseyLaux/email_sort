...
def get_emails(username):
    ...
    for document in account_info_collection.find({}):
        # Append the email and secret to the respective lists
        email_accounts.append(document["email"])
        email_secrets.append(document["secret"])
    ...
    last_email_pull_doc = account_info_collection["last_email_pull"]
