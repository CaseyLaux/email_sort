...
def categorize_emails(i_account_data):
    ...
    prompt = email["prompt"]
    openai.api_key = "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"
    ...
    try:
        ...
        if rating == 0 and category == "RATING_ERROR":
            raise ValueError("Failed to categorize email.")
        ...
        categorize_emails(i_account_data)  # Restart the script on the same email
    return 
